...
class Ui_AddMaintenanceDialog(object):
    def setupUi(self, AddMaintenanceDialog):
        if not AddMaintenanceDialog.objectName():
            AddMaintenanceDialog.setObjectName(u"AddMaintenanceDialog")
        ...
        self.formLayout.setWidget(0, QFormLayout.ItemRole.FieldRole, self.vehicleComboBox)
    ...
    def retranslateUi(self, AddMaintenanceDialog):
        AddMaintenanceDialog.setWindowTitle(QCoreApplication.translate("AddMaintenanceDialog", u"\u0e01\u0e33\u0e2b\u0e19\u0e14\u0e07\u0e32\u0e19\u0e1a\u0e33\u0e23\u0e38\u0e07\u0e23\u0e31\u0e01\u0e29\u0e32", None))
        self.vehicleLabel.setText(QCoreApplication.translate("AddMaintenanceDialog", u"\u0e23\u0e16", None))
        self.nameLabel.setText(QCoreApplication.translate("AddMaintenanceDialog", u"\u0e23\u0e32\u0e22\u0e01\u0e32\u0e23", None))
        self.odoLabel.setText(QCoreApplication.translate("AddMaintenanceDialog", u"\u0e40\u0e25\u0e02\u0e44\u0e21\u0e25\u0e4c\u0e04\u0e23\u0e1a\u0e01\u0e33\u0e2b\u0e19\u0e14", None))
        self.dateLabel.setText(QCoreApplication.translate("AddMaintenanceDialog", u"\u0e27\u0e31\u0e19\u0e04\u0e23\u0e1a\u0e01\u0e33\u0e2b\u0e19\u0e14", None))
        self.noteLabel.setText(QCoreApplication.translate("AddMaintenanceDialog", u"\u0e2b\u0e21\u0e32\u0e22\u0e40\u0e2b\u0e15\u0e38", None))
    # retranslateUi
