...
class Ui_AddVehicleDialog(object):
    def setupUi(self, AddVehicleDialog):
        ...
        self.plateLineEdit.setObjectName("plateLineEdit")
        ...
        self.formLayout.setWidget(
            3, QFormLayout.ItemRole.FieldRole, self.capacityLineEdit
        )
    ...
    def retranslateUi(self, AddVehicleDialog):
        AddVehicleDialog.setWindowTitle(
        ...
        self.nameLabel.setText(
            QCoreApplication.translate(
                "AddVehicleDialog", "\u0e0a\u0e37\u0e48\u0e2d", None
            )
        )
        self.typeLabel.setText(
            QCoreApplication.translate(
                "AddVehicleDialog", "\u0e1b\u0e23\u0e30\u0e40\u0e20\u0e17", None
            )
        )
