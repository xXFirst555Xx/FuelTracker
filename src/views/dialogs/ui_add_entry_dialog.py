...
class Ui_AddEntryDialog(object):
    def setupUi(self, AddEntryDialog):
        ...
        self.formLayout.setWidget(2, QFormLayout.ItemRole.FieldRole, self.fuelTypeComboBox)
        ...
        self.formLayout.setWidget(4, QFormLayout.ItemRole.LabelRole, self.odoBeforeLabel)
        ...
        self.formLayout.setWidget(7, QFormLayout.ItemRole.SpanningRole, self.autoFillCheckBox)
    ...
    def retranslateUi(self, AddEntryDialog):
        ...
        self.fuelTypeLabel.setText(QCoreApplication.translate("AddEntryDialog", u"\u0e0a\u0e19\u0e34\u0e14\u0e40\u0e0a\u0e37\u0e49\u0e2d\u0e40\u0e1e\u0e25\u0e34\u0e07", None))
